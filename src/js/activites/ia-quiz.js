/**
 * Quiz IA 4e/3e — TechnoDocs
 * Collection Firestore : quiz_submissions
 * wizard_id : ia-quiz-4e-3e
 *
...
const ATTEMPT_KEY = 'quiz_ia-4e3e_attempts';
...
function showBilan() {
  ...
  let message;
  if (state.score === 8) {
    message = '🏆 Excellent ! Tu maîtrises les notions clés de l\'IA.';
...
async function saveToFirestore(savedScore, attemptNumber) {
  ...
  try {
    ...
    console.error('❌ Erreur Firestore (quiz IA):', err);
  }
}
